...
public class EventoController {
    ...
    @GetMapping("/filtro")
    public ResponseEntity<List<EventoResponseDTO>> getEventosFiltrados(@RequestParam(defaultValue = "0") int page,
        ...
        List<EventoResponseDTO> eventos = eventoService.getEventosFiltrados(page, size, titulo, cidade, uf, dataInicio, dataFim);
